package com.crazy.java.ch17网络编程.s174基于UDP协议的网络编程.LanTalk;
import java.text.*;
...
class ImageCellRenderer extends JPanel implements ListCellRenderer<UserInfo> {
    ...
    @Override
    public Component getListCellRendererComponent(JList list, UserInfo userInfo, int index, boolean isSelected, boolean cellHasFocus) {
        // 设置图标
